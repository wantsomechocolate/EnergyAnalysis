...
print "--The end date you choose will also be used as the end date for bucket analysis\n"
...
interval_data_objects={}
for sheet_name in sheet_names:
    ##Initialize a IntervalDataObject with each sheet
    sheet = wb.parse(sheet_name)

    a_interval_data_object=wamo.IntervalData(sheet)

    interval_data_objects[sheet_name]=a_interval_data_object
...
##############interval_time=intewb = pd.ExcelFile(book_name)rval_data_object.date_list

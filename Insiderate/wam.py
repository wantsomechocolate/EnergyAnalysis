...
def get_lower_and_upper_bound_dates(exclude_days, weather_interval_dataframe_all, energy_interval_dataframe_all):
    ...
    print ("--The excluded days go from "+str(exclude_days_start)+" to "+str(exclude_days_end)+
           " and span about "+str(exclude_years_elap)+" years."+"\n")
    ...
    " and spans about "+str(weather_raw_data_years_elap)+" years."+"\n")
    ...
    print ("--The energy data goes from "+str(energy_raw_data_start)+" to "+str(energy_raw_data_end)+
    " and spans about "+str(energy_raw_data_years_elap)+" years."+"\n")
    ...
    if lower_bound_index==0:
        print ("--The oldest date you can use is "+str(lower_bound_date)+
        " because you don't have enough weather data to go back farther."+"\n")
    else:
        print ("--The oldest date you can use is "+str(lower_bound_date)+
               " because you don't have enough energy data to go back farther."+"\n")


    if upper_bound_index==0:
        print ("--The newest date you can use is "+str(upper_bound_date)+
               " because you don't have enough weather data to go forward."+"\n")
    else:
        print ("--The newest date you can use is "+str(upper_bound_date)+
               " because you don't have enough energy data to go forward."+"\n")
    ...
    if exclude_days_start<=lower_bound_date.date():
        ...
        print ("--The exlcuded days do not go back far enough to cover the lower bound date, which is "+
               str(lower_bound_date)+"."+"\n")
        print ("--You can go add days to the list and rerun, you can ignore this warning,\
    ...
    if exclude_days_end>=upper_bound_date.date():
        ...
        print ("--I highly recommend going to the holiday list and adding holidays.\
        You can ignore this error (don't do that)"+"\n")
...
def get_peak_week(energy_interval_dataframe, start_date_pp, end_date_pp, num_data_cols):
    ...
    pp_bounds_datetime_list=[start_timestamp, end_timestamp]

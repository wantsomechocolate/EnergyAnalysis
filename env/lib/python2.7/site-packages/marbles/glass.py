...
def getPath(default_directory, filetypes=[('All','*')]):
    ...
    filePath=tkFileDialog.askopenfilename(filetypes=filetypes)     ##  imageFile will store the filename of the image you choose
